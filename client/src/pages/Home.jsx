              ...
              <span className="inline-block">
                <Typewriter
                  words={[
                    ...
                    "ಕೃಷಿಗೆ ಸ್ಮಾರ್ಟ್ ಪರಿಹಾರಗಳು",
                    "ನವೀನ ಕೃಷಿ, ಹೆಚ್ಚು ಉತ್ಪಾದನೆ",
                    "ಸತತ ಕೃಷಿ ಸುಲಭವಾಗಿ",
                    "ನಿಮ್ಮ ಡಿಜಿಟಲ್ ಕೃಷಿ ಭಾಗಸ್ವಾಮಿ",
                  ]}
                  loop={0}
                  cursor={true}
                  cursorStyle="|"
                ...
                {[
                  {
                    title: "ಬೆಳೆ ನಿರ್ವಹಣೆ",
                    description:
                      "ಸರಿಯಾದ ಬೆಳೆ ಮತ್ತು ರಾಸಾಯನಿಕ ಗೊಬ್ಬರ ಆಯ್ಕೆ ಮಾಡಿ, ಸಂಬಂಧಿತ ರೋಗಗಳು ಮತ್ತು ಕೀಟನಾಶಕಗಳ ಮಾಹಿತಿ ಪಡೆಯಿರಿ.",
                    color: "#e9c46a",
                    iconPath:
                  ...
                  },
                  {
                    ...
                    description:
                      "ಹೊಲ ಒರೆಯಲು ಟ್ರಾಕ್ಟರ್ ಮತ್ತು ಸರಕು ಸಾಗಣೆಗೆ ವಾಹನಗಳ ಸೌಲಭ್ಯ ಪಡೆಯಿರಿ.",
                    color: "#dda15e",
                    iconPath:
                      "M8 6L12 2l4 4M12 2v10.3a4 4 0 0 1-1.172 2.872L4 22m16-4l-5-5",
                  },
                  {
                    title: "ಗೊಬ್ಬರ ಮತ್ತು ಟ್ರಾಕ್ಟರ್ ನಿರ್ವಹಣೆ",
                    description:
                      "ಸೇವಾ ಒದಗಿಸುವವರು ಗೊಬ್ಬರ ಮತ್ತು ಟ್ರಾಕ್ಟರ್ ಸೇವೆ ನೀಡುತ್ತಾರೆ; ರೈತರು ಅವನ್ನು ಬಳಸಬಹುದು.",
                    color: "#e76f51",
                    iconPath:
              ...
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="text-lg text-[#606c38] dark:text-[#fefae0]">
                    ಇತ್ತೀಚಿನ ನವೀಕರಣಗಳನ್ನು ಪಡೆಯಲು ಚಂದಾದಾರರಾಗಿ.
                  </p>
                </div>
